...
class Inflector
{
    ...
    * @access public
    * @static
    * @param    string    $class_with_ns    Fully-qualified class name
    * @return string Unqualified class name (namespace removed).
    */
    public static function denamespace($class_with_ns)
    {
    	return preg_replace('/.*\\\\([\w]+)$/', '$1', $class_with_ns);
    }
